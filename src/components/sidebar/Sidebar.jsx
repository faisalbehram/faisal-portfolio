...
import logo from '../images/faisal.JPG';
...
export default function Sidebar() {
  ...
  const iconList = [
    {
      component: github,
      href: 'https://github.com/faisalbehram'
    },
    {
      component: linkedin,
      href: 'https://www.linkedin.com/in/faisalbehram'
    },
    {
      component: twitter,
      href: 'https://twitter.com/faisalbehram'
    },
    {
      component: gmail,
      href: 'mailto:faisalbehram66@gmail.com'
    }
  ];
  const item = {
  ...
  return (
    <div className='sidebar'>
      ...
      <li className='sidebar-nav-items'>
          <Link smooth to='/#experince' className='links'>
            Experince
          </Link>
        </li>
        <li className='sidebar-nav-items'>
